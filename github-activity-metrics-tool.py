...
querylist = []
querylist.append("gwu+followers:>=" + str(config['minimumfollowers']) + "+repos:>=" + str(config['minimumrepos']))
querylist.append("george+washington+university+followers:>=" + str(config['minimumfollowers']) + "+repos:>=" + str(config['minimumrepos']))
querylist.append("location:%22george+washington+university%22&followers:>=" + str(config['minimumfollowers']) + "&repos:>=" + str(config['minimumrepos']))
